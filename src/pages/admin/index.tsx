          ...
          <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              <button
                ...
                className="inline-flex h-14 items-center justify-center gap-3 rounded-2xl bg-red-500 px-7 text-lg font-black text-white shadow-lg shadow-red-500/20 transition hover:-translate-y-1 hover:bg-red-400"
              >
